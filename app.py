...
def main():
    ...
    @st.cache_resource
    def load_model():
        model = tf.keras.models.load_model('weights-improvement-03-0.97.hdf5')
        return model
    ...
    model = load_model()
    class_names = ["Car", "Motor"]
    

    file = st.file_uploader("Choose a Motor or Car picture from your computer", type=["jpg", "png", "jpeg"])
